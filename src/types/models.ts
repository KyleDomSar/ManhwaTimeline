...
export type Manga = { id:string; title:string; altTitles?:string[]; description?:string; coverUrl?:string; status:MangaStatus; year?:number; genres:string[]; authors:string[]; artists:string[]; lastChapter?:string; lastVolume?:string; totalChapters?:number; chapterCountSource?:string; contentRating?:string; followedCount?:number; popularity?:number; favourites?:number; createdAt?:string; updatedAt?:string; };
